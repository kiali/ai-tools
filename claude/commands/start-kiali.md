---
description: Start Kiali in Minikube with Istio and Bookinfo demo
---

Execute the following steps to start Kiali in Minikube:

1. Check if Minikube is running. If not, start it with `minikube start`.

2. Install Istio by running:
   ```bash
...
4. Install the Bookinfo demo by running:
   ```bash
